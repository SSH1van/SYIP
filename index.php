    ...
    <svg style="display: none">
        <symbol id="login" viewBox="200 -200 1024 1024">
            <g transform="translate(0,1024) scale(0.14,-0.14)">
                <path
                    d="M4928 7539 c-601 -58 -969 -423 -1077 -1070 -58 -349 -47 -653 34 -934 203 -702 790 -1203 1332 -1136 531 65 1026 570 1169 1191 91 397 26 969 -149 1316 -237 469 -698 692 -1309 633z" />
                <path
    ...
    <div class="whom" id="whom">
        ...
        <div id="whom" class="whom_inner">
            <card data-image="img/whom/1.jpeg">
                ...
                <div slot="content" class="whom_text">Текст, который в настоящее время не имеет смысловой нагрузки.
                    Йови,
                    надеюсь он тут будет</div>
            </card>
            <card data-image="img/whom/2.jpeg">
    ...
    <section id="cd-timeline" class="timeline">
        <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
                ...
                <p>Текст, который в настоящее время не имеет смысловой нагрузки. Йови,
                    надеюсь он тут будет</p>
        ...
        <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
                ...
                <p>Текст, который в настоящее время не имеет смысловой нагрузки. Йови,
                    надеюсь он тут будет. Ещё немного бла бла бла бла бла бла бла бла
        ...
        <div class="cd-timeline-block">
            ...
            <div class="cd-timeline-content">
                ...
                <p>Текст, который в настоящее время не имеет смысловой нагрузки. Йови,
                    надеюсь он тут будет. Ещё немного бла бла бла бла бла бла бла бла бла бла бла бла бла бла бла бла
                    бла бла
