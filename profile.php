...
<body>
    ...
    <svg style="display: none">
        <symbol id="exit" fill="none" viewBox="0 0 24 24">
            <g>
                <path d="M15 4.00098H5V18.001C5 19.1055 5.89543 20.001 7 20.001H15" stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M16 15.001L19 12.001M19 12.001L16 9.00098M19 12.001H9" stroke="#fff" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" />
            </g>
        </symbol>
        <symbol id="home">
            <g fill="#fff" viewBox="0 0 24 24">
